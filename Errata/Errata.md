...
| 5 | 225 | 式19-8与式19-9 A与AT写反 | 技术错误 | 式19-8应改为AAT，式19-9应改为ATA，对应公式下的变量和描述也随公式进行修正 | 
| 6 | 253 | 式22-9和后一行\theta_A 和 \theta_B 符号错误 | 技术错误  | 应改为\theta_B 和 theta_C |
| 7 | 265 | 式23-22、23-24、式23-25局部有误 | 技术错误 | 式23-22、23-24条件概率\|应在Ot后，式23-25倒数第二个式最后一个\|应为逗号 |
